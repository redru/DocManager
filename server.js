...
app.use('/docmanager', jwt({ secret: 'Ad54_TyrwZ0?96'}).unless({path: [ '/docmanager/', '/docmanager/index.html', '/docmanager/views/authentication_view.html', '/docmanager/authenticate' ]}),
